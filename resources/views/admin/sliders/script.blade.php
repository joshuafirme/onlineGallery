    ...
    $(function() {
        ...
        $(document).on('click', '.btn-edit', function() {
            ...
            if (data) {
                ...
                mdl.find('.modal-title').text('Update slider');
                mdl.find('form').attr('action', "/sliders/update/" + data.id);
                ...
                mdl.find('.modal-title').text('Add slider');

                mdl.find('form').attr('action', `{{ route('sliders.store') }}`)
