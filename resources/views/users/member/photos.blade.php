    ...
    <div class="gallery-container">
        <div class="gallery-item">
            @forelse ($media as $singleMedia)
                @if (strpos($singleMedia->file_path, '.jpg') !== false ||
                        strpos($singleMedia->file_path, '.jpeg') !== false ||
                        strpos($singleMedia->file_path, '.png') !== false ||
                        strpos($singleMedia->file_path, '.gif') !== false)
